...
public class SearchResultsListDataModel implements Serializable {
    ...
    public SearchResultsListDataModel(String dormitoryName, String dormitoryShortDescription, String dormitoryRating, String dormitoryRatingStatus, String dormitoryImageUrl, String dormitoryId) {
        this.dormitoryName = dormitoryName;
        this.dormitoryShortDescription = dormitoryShortDescription;
        this.dormitoryRating = dormitoryRating;
        this.dormitoryRatingStatus = dormitoryRatingStatus;
